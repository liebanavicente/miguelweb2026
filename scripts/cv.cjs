...
const children = [
  ...
  ...entry("Grupo musical No Flag Patriots", "", "Compositor, músico y cantante", "Ene 2010 – Actualidad"),
  bullet("Composición, interpretación y directo con el grupo."),
  bullet("Desarrollo de la web oficial del grupo (noflagpatriots.com)."),
  bullet("Desarrollo de la tienda de ropa del grupo (nfpclothing.com) con Next.js y pagos Stripe, conectada a Gelato por API."),
  ...
  ...entry("Konecta (servicios para AMBici y Securitas Direct)", "", "Teleoperador", "Ene 2023 – Sep 2023"),
  bullet("Atención telefónica a clientes, resolución de incidencias y gestión de solicitudes."),
  ...entry("Club de Polo Ampurdán", "", "Administrativo", "Ene 2022 – Oct 2022"),

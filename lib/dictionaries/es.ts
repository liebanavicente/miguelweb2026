...
export const es: Dictionary = {
  ...
  jobs: {
    ...
    items: {
      ctti: { role: "Recepcionista / administrativo", company: "CTTI · Generalitat de Catalunya" },
      nfp: { role: "Compositor, músico y cantante", company: "Grupo musical No Flag Patriots" },
      konecta: { role: "Teleoperador", company: "Konecta · AMBici · Securitas Direct" },
      polo: { role: "Administrativo", company: "Club de Polo Ampurdán" },
      tic: { role: "Especialista en métodos didácticos (Coordinador T.I.C.)", company: "Escola Joan Maragall" },
      teacher: { role: "Profesor de educación primaria", company: "Escoles Gornal · Bernat Metge · Torre de la Miranda · Joan Maragall" },
      bar: { role: "Camarero", company: "Bar La Concha" },
      sales: { role: "Vendedor", company: "El Corte Inglés · Boulangerie · comercio" },
    },
  },
  skills: {
